...
- A [cloud coding agent](../concepts/cloud-coding-agent.md) picking up a GitHub issue and autonomously applying TDD: writing a test that reproduces the reported bug (red), fixing the code (green), and including both the test and the fix in the pull request.
