...
- [Function calling](../concepts/function-calling.md) (schema-constrained business API tools: order lookup, refund processing, account modification, ticket creation, escalation routing)
