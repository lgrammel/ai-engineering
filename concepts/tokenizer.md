...
A tokenizer is the encoding/decoding scheme (algorithm plus vocabulary and special tokens) that converts raw text into token IDs and converts token IDs back into text for a [model](./model.md).
