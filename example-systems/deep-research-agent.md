...
Deep research tasks are [inference-cost](../concepts/inference-cost.md) intensive. Each task processes large volumes of web content through the [context](../concepts/context.md) across many agent loop iterations, consuming significantly more tokens than a standard chat turn. [Prompt compaction](../concepts/prompt-compaction.md) and progressive summarization of intermediate findings are necessary to fit accumulated research into the [context size](../concepts/context.md) limits. Providers typically rate-limit deep research queries separately from standard chat because of the [inference cost](../concepts/inference-cost.md).
