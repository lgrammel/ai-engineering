...
In [agent](./agent.md) systems, a sandbox is where "tools" run (shell commands, code interpreters, file edits) so the [agent](./agent.md) can operate on a workspace without giving it full host privileges.
